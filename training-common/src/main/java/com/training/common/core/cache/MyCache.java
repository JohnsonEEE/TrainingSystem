...
public interface MyCache {
    ...
    Object putIfAbsent(CacheType cacheType, String key, Object value);

    boolean delete(CacheType cacheType, String key);

    Map<String, Object> getAllCache();

    Map<String, Object> getAllCache(CacheType cacheType);
